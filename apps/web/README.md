...
This app is part of the Nx workspace. Run the commands below from `apps/web`, or start it from the
workspace root with `pnpm dev:web`.
...
- Docker build context: workspace root (`.`)
- Container port: `3000`
- Health check path: `/`
