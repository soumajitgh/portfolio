...
export function HomeHero({ settings }: Pick<PortfolioHomeData, 'settings'>) {
  return (
    <section className="grid min-h-0 items-center py-4 sm:py-[clamp(1.5rem,4dvh,3rem)] md:grid-cols-[minmax(0,1fr)_18rem] md:gap-5 lg:grid-cols-[minmax(0,1fr)_20rem] lg:gap-8">
